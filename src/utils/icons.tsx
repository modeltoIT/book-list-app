export const icons = {
  ...
  addNewBook: <svg
              ...
              >
                <path fill="#fff" d="M2 5C2 3.34315 3.34315 2 5 2H15C16.6569 2 18 3.34315 18 5V9.28988C17.3663 9.10128 16.695 9 16 9C12.134 9 9 12.134 9 16C9 16.695 9.10128 17.3663 9.28988 18H5C4.44772 18 4 18.4477 4 19C4 19.5523 4.44772 20 5 20H10.2547C10.8179 20.8074 11.5469 21.4905 12.3924 22H5C3.34315 22 2 20.6569 2 19V5Z"/>
                <path
                  fill="#fff"
                  fillRule="evenodd"
  ...
  switchBtn: <svg
                ...
                className="w-7 h-7"
              >
                <path d="M29.49 12.45a14.08 14.08 0 1 1-19.57 13c0-5.7 2.86-10.35 8.58-13l1 2.36a11.52 11.52 0 1 0 16 10.61 11.28 11.28 0 0 0-7-10.61l1-2.36Z"/>
